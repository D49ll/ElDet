...
# -------------------------------
# Note: Although standard COCO format includes a "categories" field,
# the ElDet instructions may not require it. Here we produce JSON files with only "images" and "annotations".
train_json = {
    "images": train_images,
